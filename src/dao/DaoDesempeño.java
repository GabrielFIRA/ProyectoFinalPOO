...
public class DaoDesempeño {
	...
	public DaoDesempeño(){
            ...
            insertarDesempeño = conn.prepareStatement("Insert into Desempeño"
                    ...
                    + "periodoContratado, puesto, razonSalida, salario,"
            ...
            modificarDesempeño = conn.prepareStatement("Update Desempeño set"
                    ...
                    + "numCedula = ?, periodoContratado = ?, puesto = ?, "
     ...
     * @param idDesempeño
	 * @param notasDisiplinarias    puede ser nulo
	 * @param periodoContratado    puede ser nulo
	 * @param puesto
	...
	public int agregarDesempeño(double calificacion, 
                ...
                String notasDisiplinarias, int periodoContratado,
	...
	public int agregarDesempeñoBD(Desempeño des){
            ...
            try{
                ...
                insertarDesempeño.setInt(8, des.getPeriodoContratado());
	...
	public int modificarDesempeñoBD(Desempeño des){
            ...
            try{
                ...
                modificarDesempeño.setInt(7, des.getPeriodoContratado());
	 ...
	 * @param notasDisiplinarias
	 * @param indexNotasDisiplinarias
	 * @param periodoContratado
	 * @param razonSalida
	 * @param salario
	 */
	public int modificarDesempeño(int idDesempeño, int idProyecto, 
                ...
                int indexNotasDisiplinarias, int periodoContratado,
            ...
            try{
                for(Desempeño des: listaDesempeño){
                    if(des.getIdDesempeño() == idDesempeño){
                        ...
                        des.setPeriodoContratado(periodoContratado);
